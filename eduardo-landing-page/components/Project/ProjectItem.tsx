  ...
  return (
    <article
      className="
        ...
        backdrop-blur-sm
        hover:border-green-500/50 hover:bg-white/10 hover:shadow-[0_0_15px_rgba(34,197,94,0.15)]
        transition-all duration-300 ease-in-out
      "
    >
      <div>
        <div className="flex justify-between items-start mb-4">
          <h3 className="text-xl font-bold text-slate-100 group-hover:text-green-300 transition-colors">
            {data.title}
          </h3>

          {data.pinned && (
            <div className="flex items-center gap-1 px-2 py-1 rounded-full bg-green-500/20 border border-green-500/30 text-green-300 text-xs font-medium">
              <Pin size={12} />
              <span>Destaque</span>
            </div>
          )}
