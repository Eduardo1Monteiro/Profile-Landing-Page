  ...
  return (
    <main className="flex flex-col gap-16 min-h-screen w-full px-6 pt-24 pb-20 max-w-5xl mx-auto">
      ...
      <section id="tech-stack" className="flex flex-col gap-8">
        <div className="h-px w-full bg-gradient-to-r from-green-500/50 via-green-500/10 to-transparent"></div>
          ...
          {technologies.map((tech) => (
            <div
              ...
              className="
                ...
                hover:border-green-500/50 hover:text-green-300 hover:bg-white/10
